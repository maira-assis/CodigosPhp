...
<body class="center clearfix">
	...
	<section class="container">
		<div>
		<form method="post" action="controle/executa_calculo_pg.php">
		O preço da coxinha é R$3,00 <input placeholder="digite quantidade" type="number" name="coxinha"><br>
		O preço do pudim é R$1,50 <input placeholder="digite quantidade" type="number" name="pudim"><br>
		O preço da bisnaga é R$2,00 <input placeholder="digite quantidade" type="number" name="bisnaga"><br>
		O preço do Leite é R$3,20 <input placeholder="digite quantidade" type="number" name="leite"><br>
		<input type="submit" value="Calcular PG">
		</form>
		</div>
