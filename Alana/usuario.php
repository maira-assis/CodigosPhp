...
$matricula-usuario=mysqli_real_escape_String($dbc,trim($_POST['id_usuario']));
$sexo=mysqli_real_escape_String($dbc,trim($_POST['sexo']));
$dt_nasc =mysqli_real_escape_String($dbc,trim($_POST['dt_nasc_usuario']));
...
$telefone=mysqli_real_escape_String($dbc,trim($_POST['telefone_usuario']));
...
<form method="post" action=" ">
	...
	<label>Endereço:</label><input type="text" name="endereco" id="endereço" placeholder="Informe o seu endereço">
