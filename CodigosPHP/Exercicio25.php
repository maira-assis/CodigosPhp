...
<body>
<center>
<p>Inicie uma variavel com zero e faça a divisão ate que seja menor ou igual a 20 </p>
</center>
<?php
...
echo "1 / 1 = ".$mult1 / 1; echo "<br>";
echo "1 / 2 = ".$mult1 / 2; echo "<br>";
echo "1 / 3 = ".$mult1 / 3; echo "<br>";
echo "1 / 4 = ".$mult1 / 4; echo "<br>";
echo "1 / 5 = ".$mult1 / 5; echo "<br>";
echo "1 / 6 = ".$mult1 / 6; echo "<br>";
echo "1 / 7 = ".$mult1 / 7; echo "<br>";
echo "1 / 8 = ".$mult1 / 8; echo "<br>";
echo "1 / 9 = ".$mult1 / 9; echo "<br>";
echo "1 / 10 = ".$mult1 / 10; echo "<br>";
echo "<hr>";
break;
